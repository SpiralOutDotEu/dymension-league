...
contract CosmoShipsTest is Test {
    ...
    bytes32 initialMerkleRoot =
        bytes32(
            0xd67e5a7bb77ee4c5e38947df0fd5fd577eb7bd77d03d8e86b4b6adf3c0ad4bc2
        );
    ...
    function testFail_MintWithoutPayment() public {
        uint256 tokenId = 1;
        CosmoShips otherNft = new CosmoShips(
            initialMerkleRoot,
            tokenId,
            initialMintPrice,
            deployer,
    ...
    function testUpdateMintPrice() public {
        ...
        assertEq(
            nft.mintPrice(),
            newPrice,
            "Mint price was not updated correctly"
        );
    }
    ...
    function testUpdateMerkleRoot() public {
        ...
        assertEq(
            nft.merkleRoot(),
            newRoot,
            "Merkle root was not updated correctly"
        );
    }
